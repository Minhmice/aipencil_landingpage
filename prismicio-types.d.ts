...
export interface SettingsDocumentDataNavigationItem {
  ...
  /**
   * Type field in *Settings → Navigation*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.navigation[].type
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  type: prismic.SelectField<"button_1" | "dropdown" | "normal" | "button_2">;
}
...
/**
 * Item in *Bento → Default → Primary → bento_box*
 */
export interface BentoSliceDefaultPrimaryBentoBoxItem {
  /**
   * Title field in *Bento → Default → Primary → bento_box*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
  ...
  /**
   * Body field in *Bento → Default → Primary → bento_box*
   *
  ...
  /**
   * Image field in *Bento → Default → Primary → bento_box*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
  ...
  /**
   * Wide field in *Bento → Default → Primary → bento_box*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: true
...
export interface BentoSliceDefaultPrimary {
   ...
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: Italic và red text
  ...
  /**
   * bento_box field in *Bento → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
...
/**
 * Primary content in *SuperHero → Default → Primary*
 */
export interface HeroSliceDefaultPrimary {
  /**
   * Heading field in *SuperHero → Default → Primary*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
  ...
  /**
   * Body field in *SuperHero → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
  ...
  /**
   * Link field in *SuperHero → Default → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
  ...
  /**
   * ButtonLabel field in *SuperHero → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
  ...
  /**
   * Image field in *SuperHero → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
...
/**
 * Default variation for SuperHero Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
...
/**
 * Slice variation for *SuperHero*
 */
type HeroSliceVariation = HeroSliceDefault;

/**
 * SuperHero Shared Slice
 *
 * - **API ID**: `hero`
 * - **Description**: Hero
 * - **Documentation**: https://prismic.io/docs/slice
...
export interface ShowcaseSliceDefaultPrimary {
  ...
  /**
   * Button_text field in *Showcase → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
  ...
  /**
   * Button_link field in *Showcase → Default → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
