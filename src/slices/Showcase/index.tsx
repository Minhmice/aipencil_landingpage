...
const Showcase = ({ slice }: ShowcaseProps): JSX.Element => {
  return (
    ...
    >
      ...
      <div className="mt-16 grid items-center gap-8 rounded-xl border border-border/20 bg-gradient-to-b from-card/15 to-card/5 px-8 py-8 backdrop-blur-sm lg:grid-cols-3 lg:gap-0 lg:py-12">
        <div>
          <div className="w-fit rounded-lg bg-primary/35 p-4 text-3xl text-primary">
          ...
          <div className="prose prose-invert mt-4 max-w-xl text-muted-foreground">
